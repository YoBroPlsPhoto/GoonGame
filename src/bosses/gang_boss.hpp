...
enum class GangCutscene { WARDROBE_FALLING, WARDROBE_LANDED, PORTAL_OPENING, GUYS_WALKING_OUT, FIGHT, POST_FIGHT, RETREATING, WARDROBE_RETREAT_OPENING, WARDROBE_CLOSING, RETREATED };
